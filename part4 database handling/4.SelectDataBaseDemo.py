# Form implementation generated from reading ui file '.\SelectDataBaseDemo.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # connect signal
        self.pushButton.clicked.connect(self.select_databass)
    ...
    def select_databass(self):
        try:
            ...
            mycursor.execute(f"SELECT * FROM {tblname}")

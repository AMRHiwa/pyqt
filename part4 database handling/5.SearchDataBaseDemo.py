# Form implementation generated from reading ui file '.\SearchDataBaseDemo.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # connect signal
        self.pushButton.clicked.connect(self.search_db)
    ...
    def search_db(self):
        ...
        try:
            ...
            query = f"SELECT password FROM {tblname} WHERE username like '{username}'"
            mycursor.execute(query)
            row = mycursor.fetchone()
            if row == None:
                self.label_result.setText("User not found with this username !")
            else :
